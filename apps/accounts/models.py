...
class BankAccountType(DefaultModelFields, models.Model):
...
class UserBankAccount(DefaultModelFields, models.Model):
...
class UserAddress(DefaultModelFields, models.Model):
    user = models.OneToOneField(
        User,
